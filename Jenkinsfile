    ...
    stages{
      stage("1. Git clone from repo"){
        steps{
         ...
         git branch: 'main', url: 'https://github.com/EdwinBlewusi/Edjenkins-web-app.git'
      ...
      stage("5. Deploying to Tomcat in UAT"){
        steps{
           ...
           deploy adapters: [tomcat9(credentialsId: 'tomcat_cred', path: '', url: 'http://54.85.49.135:9090')], contextPath: null, war: 'target/*.war'
        }  
      }
      ...
      stage("6. Email Notification"){
        steps{
            ...
            emailext body: 'The Deployment is Successful', subject: 'Deployment Success', to: 'edwinblewusi@gmail.com'
        }  
      }
    }
}
